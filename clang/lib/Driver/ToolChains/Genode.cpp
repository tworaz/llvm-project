...
void
Genode::AddClangSystemIncludeArgs(const llvm::opt::ArgList &DriverArgs,
...
Genode::addLibStdCxxIncludePaths(const llvm::opt::ArgList &DriverArgs,
  ...
  if (Generic_GCC::addGCCLibStdCxxIncludePaths(DriverArgs, CC1Args, TripleStr))
    return;
  ...
  addLibStdCXXIncludePaths(IncludePath, TripleStr, Multilib.includeSuffix(),
                           DriverArgs, CC1Args);
}
...
ToolChain::RuntimeLibType Genode::GetDefaultRuntimeLibType() const {
